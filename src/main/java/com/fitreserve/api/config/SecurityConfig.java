...
import com.fitreserve.api.security.CustomUserDetailsService;
import com.fitreserve.api.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/clases/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/clases/**").hasRole("ADMIN")
                        .requestMatchers("/api/reservas/**").hasAnyRole("ADMIN", "MEMBER")
