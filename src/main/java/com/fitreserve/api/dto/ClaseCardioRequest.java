...
public record ClaseCardioRequest(
        ...
        @NotNull(message = "Las calorías estimadas son obligatorias")
        @Min(value = 1, message = "Las calorías deben ser mayores que 0")
        Integer caloriasEstimadas,

        @NotBlank(message = "El tipo de cardio es obligatorio")
        String tipoCardio
) {
}
