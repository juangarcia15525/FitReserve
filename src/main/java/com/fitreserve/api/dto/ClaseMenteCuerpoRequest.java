...
public record ClaseMenteCuerpoRequest(
        ...
        @NotNull(message = "El nivel de relajación es obligatorio")
        @Min(value = 1, message = "El nivel de relajación debe ser mayor que 0")
        Integer nivelRelajacion,

        @NotNull(message = "Indica si requiere esterilla")
